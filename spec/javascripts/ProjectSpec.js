describe("A Project", function() {
  ...
  describe("fetching a project with skills", function() {
    beforeEach(function() {
      var json = JSON.parse("{\"id\":null,\"title\":\"I love parsing!\",\"url\":\"http://github.com\",\"body\":null,\"image_url\":null,\"skills\":[{\"id\":null,\"name\":\"Ruby\",\"project_id\":null},{\"id\":null,\"name\":\"Backbone.js\",\"project_id\":null},{\"id\":null,\"name\":\"RSpec\",\"project_id\":null}]}");
    ...
    it("should hold a collection of all the associated skills", function() {
      expect(project.skills.length).toEqual(3);
    });
  });
